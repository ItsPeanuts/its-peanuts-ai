...
const nl: TranslationSet = {
  ...
  subscription: {
    ...
    freeMonthRegNotice: "Eerste maand Growth gratis — geen creditcard nodig",
    trialTitle: "Eerste maand Growth gratis — geen creditcard nodig",
    trialSub: "Probeer het Growth pakket (€149/maand) volledig gratis. Geen creditcard nodig, geen verplichtingen.",
...
const en: TranslationSet = {
  ...
  subscription: {
    ...
    freeMonthRegNotice: "First month of Growth free — no credit card required",
    trialTitle: "First month of Growth free — no credit card required",
    trialSub: "Try the Growth plan (€149/month) completely free. No credit card, no commitment.",
...
const de: TranslationSet = {
  ...
  subscription: {
    ...
    freeMonthRegNotice: "Erster Monat Growth kostenlos — keine Kreditkarte",
    trialTitle: "Erster Monat Growth kostenlos — keine Kreditkarte",
    trialSub: "Teste das Growth-Paket (€149/Monat) komplett kostenlos. Keine Kreditkarte, keine Verpflichtung.",
...
const fr: TranslationSet = {
  ...
  subscription: {
    ...
    freeMonthRegNotice: "Premier mois Growth gratuit — sans carte bancaire",
    trialTitle: "Premier mois Growth gratuit — sans carte bancaire",
    trialSub: "Essayez le plan Growth (€149/mois) entièrement gratuit. Sans carte bancaire, sans engagement.",
...
const es: TranslationSet = {
  ...
  subscription: {
    ...
    freeMonthRegNotice: "Primer mes Growth gratis — sin tarjeta de crédito",
    trialTitle: "Primer mes Growth gratis — sin tarjeta de crédito",
    trialSub: "Prueba el plan Growth (€149/mes) completamente gratis. Sin tarjeta de crédito, sin compromiso.",

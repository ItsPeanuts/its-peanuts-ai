...
const en: TranslationSet = {
  ...
  terms: {
    ...
    sections: [
      ...
      { title: "8. Personal data and processor role", content: "", items: ["For candidate data that reaches an employer through the platform, the employer is the data controller under the GDPR.", "Insofar as VorzaIQ processes personal data on behalf of the employer, VorzaIQ acts as a data processor. The data processing agreement (Annex 1, available at vorzaiq.com/verwerkersovereenkomst) forms an integral part of these terms and is deemed to have been entered into upon creation of an employer account.", "Our privacy policy applies to the processing of personal data by VorzaIQ as controller."] },
